...
export function getDefaultToolbarItems(): ToolbarItem[] {
  return [
    ...
    { command: "heading1", label: "Heading 1", icon: ICONS.heading1, shortcut: "Ctrl+Alt+1" },
    { command: "heading2", label: "Heading 2", icon: ICONS.heading2, shortcut: "Ctrl+Alt+2" },
    { command: "heading3", label: "Heading 3", icon: ICONS.heading3, shortcut: "Ctrl+Alt+3" },
    { command: "divider", label: "", icon: "", divider: true },
    { command: "unorderedList", label: "Bullet List", icon: ICONS.unorderedList, shortcut: "Ctrl+Shift+8" },
    { command: "orderedList", label: "Numbered List", icon: ICONS.orderedList, shortcut: "Ctrl+Shift+7" },
